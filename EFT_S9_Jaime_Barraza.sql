...
WHERE EXISTS (
    ...
    WHERE stt.cod_tipo_transac = ttt.cod_tptran_tarjeta
);
...
Se necesita identificar los tipos de transacciones con un determinado comportamiento en los montos y mes de vencimiento de las cuotas 
para mejorar la satisfacción de los clientes de Replee S.A.

2) ¿Cuál es la información significativa que necesita para resolver el problema?
La información relevante incluye los tipos de transacciones, montos de las transacciones y fechas de vencimiento de las cuotas.

3) ¿Cuál es el propósito de la solución que se requiere?
El propósito es obtener un resumen de los tipos de transacciones con sus montos promedio y meses de vencimiento, 
para luego ajustar la tasa de interés y mejorar la oferta a los clientes según el comportamiento identificado.

4) Detalle los pasos, en lenguaje natural, necesarios para construir la alternativa que usa SUBCONSULTA:
    1.  Crear una tabla temporal llamada SELECCION_TIPO_TRANSACCION para almacenar los resultados de la subconsulta.
    2.  En la subconsulta, seleccionar el código y nombre del tipo de transacción, y calcular el promedio del monto de las transacciones.
    3.  Filtrar las transacciones para incluir solo aquellas cuyo mes de vencimiento esté entre junio y diciembre.
    4.  Agrupar los resultados por código y nombre del tipo de transacción.
    5.  Mostrar la fecha, el código y nombre del tipo de transacción, y el monto promedio de la tabla SELECCION_TIPO_TRANSACCION.
    6.  Ordenar los resultados por el monto promedio.

5) Detalle los pasos, en lenguaje natural, necesarios para construir la alternativa que usa OPERADOR SET:
    1.  Seleccionar la fecha actual, el código y nombre del tipo de transacción, y calcular el promedio del monto de las transacciones.
    2.  Filtrar los tipos de transacciones para incluir solo aquellos cuyo código esté presente en el conjunto de códigos de transacciones con 
        fecha de vencimiento entre junio y diciembre.
    3.  Agrupar los resultados por código y nombre del tipo de transacción.
    4.  Ordenar los resultados por el monto promedio.
*/
